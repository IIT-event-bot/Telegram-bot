...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.getUsersByGroup = channel.unary_stream(
                '/user_service.UserService/getUsersByGroup',
                request_serializer=user__service__pb2.GroupRequest.SerializeToString,
                response_deserializer=user__service__pb2.UserResponse.FromString,
                )
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'getUsersByGroup': grpc.unary_stream_rpc_method_handler(
                    servicer.getUsersByGroup,
                    request_deserializer=user__service__pb2.GroupRequest.FromString,
                    response_serializer=user__service__pb2.UserResponse.SerializeToString,
            ),
    }
...
class UserService(object):
    ...
    def getUsersByGroup(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/user_service.UserService/getUsersByGroup',
            user__service__pb2.GroupRequest.SerializeToString,
            user__service__pb2.UserResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
